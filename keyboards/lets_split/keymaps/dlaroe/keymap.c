 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI |  \   | Alt  | TGLwr|SpcRse| Space|Raise |   [  |   -  |   =  |   ]  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL, KC_LGUI, KC_BSLS, KC_LALT, TT(3),  LT(4, KC_SPC),  KC_SPC,  RAISE,   KC_LBRC, KC_MINS, KC_EQL, CTL_T(KC_RBRC) \
),
 ...
 */
[_LOWER] = LAYOUT( \
   KC_DEL,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_6,    KC_P7,     KC_P8,    KC_P9,    KC_0,  _______, \
  ...
  KC_ESC, KC_LCTL, KC_LGUI, KC_LALT, _______, _______,   KC_P0, _______,   KC_PDOT,  KC_PENT, KC_PEQL,  KC_ESC \
),
