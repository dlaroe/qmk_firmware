 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI |  \   | Alt  |Space | Lower| Space|Raise |   [  |   -  |   =  |   ]  |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  KC_LCTL, KC_LGUI, KC_BSLS, KC_LALT, KC_SPC, TT(3),   KC_SPC,  RAISE,   KC_LBRC, KC_MINS, KC_EQL, CTL_T(KC_RBRC) \
),
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  |   ,  |   .  |   /  |Enter |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Ctrl |  GUI |  \   | Alt  |Space | Lower| Space|Raise | Left | Down |  Up  |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_ARROW] = LAYOUT( \
  KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,   KC_T,    KC_Y,    KC_U,   KC_I,    KC_O,   KC_P,    KC_BSPC, \
  KC_TAB,  KC_A,    KC_S,    KC_D,    KC_F,   KC_G,    KC_H,    KC_J,   KC_K,    KC_L,   KC_SCLN, KC_QUOT, \
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,   KC_B,    KC_N,    KC_M,   KC_COMM, KC_DOT, KC_SLSH, SFT_T(KC_ENT), \
  KC_LCTL, KC_LGUI, KC_BSLS, KC_LALT, KC_SPC, TT(3),   KC_SPC,  RAISE,  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT \
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Alt  |   4  |   3  |   2  |Space | Lower| Space|Raise | Left | Down |  Up  | Right|
 * `-----------------------------------------------------------------------------------'
 */
[_GAME] = LAYOUT( \
  ...
  KC_LALT,   KC_4,    KC_3,    KC_2,  KC_SPC,   LOWER,  KC_SPC,   RAISE,  KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT \
),
 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |  Esc |      |      |      |      |      |   0  |      |  .   | Shift| Esc  |Enter |
 * `-----------------------------------------------------------------------------------'
 */
[_LOWER] = LAYOUT( \
   KC_DEL,   KC_1,    KC_2,    KC_3,    KC_4,    KC_5,   KC_6,    KC_7,     KC_8,    KC_9,    KC_0,  _______, \
   KC_TAB, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,  KC_F6,    KC_4,     KC_5,    KC_6,  KC_PPLS,  KC_PMNS, \
  _______,  KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11, KC_F12,    KC_1,     KC_2,    KC_3, _______,  KC_PAST, \
  KC_ESC, KC_LCTL, KC_LGUI, KC_LALT, _______, _______,   KC_P0, _______,   KC_PDOT,  KC_RSFT, KC_ESC,  KC_PENT \
),
...
[_RAISE] = LAYOUT( \
  ...
  _______,   KC_WH_D,   KC_MS_L, KC_MS_D, KC_MS_R, KC_NO, KC_MINS, KC_EQL, KC_LBRC, KC_RBRC, KC_BSLASH, _______, \
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |Arrow |      |Aud on|Audoff| Game |AGswap|AGnorm|      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_ADJUST] = LAYOUT( \
  ...
  KC_CAPS, ARROW, _______, AU_ON,   AU_OFF,  GAME, AG_SWAP, AG_NORM,  _______, _______,  _______,  _______, \
  _______, MUV_DE,  MUV_IN,  MU_ON,   MU_OFF,  KC_MPRV, KC_MNXT,  KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, \
  BACKLIT, _______, _______, _______, _______, _______, KC_MPLY, _______, BL_TOGG, BL_DEC , BL_INC , BL_STEP \
)
